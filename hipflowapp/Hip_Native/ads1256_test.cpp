		...
		*/
		...
		/*	ADCON: A/D Control Register (Address 02h)
			...
			Bits 2-0 PGA2, PGA1, PGA0: Programmable Gain Amplifier Setting
				...
				111 = 64
		*/
		buf[2] = (unsigned char)((0 << 5) | (0 << 3) | (_gain << 0));
...
static void ADS1256_SetChannal(uint8_t _ch)
{
	...
	*/
	...
	ADS1256_WriteReg(REG_MUX, (uint8_t)((_ch << 4) | (1 << 3)));	/* Bit3 = 1, AINN connection AINCOM */
}
...
void Write_DAC8552(uint8_t channel, uint16_t Data)
{
	// unused uint8_t i;
	 ...
	 CS_0() ;
      ...
      bcm2835_spi_transfer((uint8_t)(Data&0xff));  
      CS_1() ;
}
/*
*********************************************************************************************************
...
*********************************************************************************************************
*/
#if 0 /* this functionality is used in IOthread.cpp */
int  main()
{
      uint8_t id;
  	int32_t adc[8];
