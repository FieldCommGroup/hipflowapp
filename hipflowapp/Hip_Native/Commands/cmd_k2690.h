...
class cmd_2690 : public cmd_base
{
	uint8_t activeDevVar;
public: // c.dtor
	cmd_2690():cmd_base(2690) {	};
	~cmd_2690(){};
...
uint8_t cmd_2690::extractData(uint8_t &ByteCnt, uint8_t *pData)
{
	...
	{
		ret = totDirection.extractSelf(&pData, &ByteCnt, chngCnt);
...
uint8_t cmd_2690::insert_Data(uint8_t &ByteCnt, uint8_t *pData) 
{
	int ret = 0;
	ByteCnt = 0; // just in case
	do // once
